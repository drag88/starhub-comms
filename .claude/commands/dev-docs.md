...
- Check `BEST_PRACTICES.md` for coding standards (if exists)
- Check `TROUBLESHOOTING.md` for common issues to avoid (if exists)
- Check `dev/README.md` for task management guidelines (if exists)
- Reference `CLAUDE.md` for project-specific development standards
