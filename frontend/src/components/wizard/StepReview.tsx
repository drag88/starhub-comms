...
export function StepReview({ data }: { data: CampaignFormData }) {
  return (
    <div className="space-y-6">
      <WizardSection title="Campaign Summary">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <p className="mt-1">
                {data.promotion_details?.pricing?.discount
                  ? `${data.promotion_details.pricing.discount}%`
                  : '-'}
              </p>
            </div>
            <div>
              ...
              <p className="mt-1">
                {data.promotion_details?.pricing?.contract_duration
                  ? `${data.promotion_details.pricing.contract_duration} Months`
                  : '-'}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              ...
              {(!data.promotion_details?.features || data.promotion_details.features.length === 0) && (
